        ...
        <div className="flex-1 px-6 py-8 space-y-4">
          {tabs.map((tab) => (
            <Button
              ...
              className={cn(
                "w-full text-center rounded-xl font-bold text-white text-lg transition-all duration-300 shadow-md hover:shadow-lg active:scale-[0.97] py-4", // ✅ removi h-16, usei padding
                activeTab === tab
