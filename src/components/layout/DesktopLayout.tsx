    ...
    <div className="min-h-screen bg-pink-50 flex">
      ...
      >
        ...
        <div className="flex-1 p-8 space-y-3">
          {tabs.map((tab) => (
            <Button
              ...
              className={cn(
                "w-full justify-start rounded-3xl font-semibold text-white text-base transition-all duration-300 shadow-md hover:shadow-lg active:scale-[0.97] py-5 px-4", // ✅ removi h-16, usei padding
                activeTab === tab
        ...
        <div className="p-6 pb-8 border-t border-pink-300">
          <Button
            variant="outline"
            className="w-auto justify-start gap-3 h-14 text-white bg-white/20 border-white/30 hover:bg-white/30 hover:text-white transition-all rounded-3xl"
