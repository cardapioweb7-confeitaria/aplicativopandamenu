        ...
        <div className="flex-1 p-8 space-y-3">
          {tabs.map((tab) => (
            <Button
              ...
              className={cn(
                "w-fit justify-start rounded-3xl font-semibold text-white text-base transition-all duration-300 shadow-md hover:shadow-lg active:scale-[0.97] py-5 px-4", // ✅ removi h-16, usei padding
                activeTab === tab
